/**
 * Local smoke — thin wrapper around the shared clinic smoke suite.
 * Run with the default playwright config: npx playwright test
 * Mirrors prod-smoke.spec.ts in structure; uses SQLite + resetLocalData.
 */
import { expect, type APIRequestContext } from "@playwright/test";

import { apiGet, apiPost, resetLocalData } from "./helpers";
import {
  registerSmokeTests,
  type PatientSpec,
  type SmokeEnv,
