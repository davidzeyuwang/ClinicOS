...
//
// 3 patients × full workflow + multi-visit + DB assertions + PDF + tabs.
// Lives here so all local E2E tests are in one file, but runs in its own
// test.describe with beforeAll/afterAll (independent of the beforeEach above).
