...
// ── Local smoke suite (shared with prod-smoke.spec.ts via clinic-smoke-suite) ─
//
// Runs the same 11-step end-to-end scenario as prod-smoke, using SQLite and
// resetLocalData for setup.  beforeAll creates the room/staff/patients once;
// the single test runs the full workflow sequentially.
...
const _SMOKE_PATIENTS: PatientSpec[] = [
  ...
  },
  {
    ...
    copay: "",               // no_charge — DB stores null
